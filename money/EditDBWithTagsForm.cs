...
namespace money
{
    public partial class EditDBWithTagsForm : EditDBForm
    {
        ...
        CheckSum checkSum; //нужна ли прроверка на отрицательный баланс (для расходов)//----------------убрать, добавить массив с полями и условиями
        bool isReserve; //проводится ли операция для резерва или для основы //--------------------------убрать, добавить резерв в осн. форме
        ...
        public EditDBWithTagsForm(string selectDataGridViesEdit, 
        ...
        public void UpdateTegs()//берёт все теги из базы
        {
            ...
            //добавленные теги
            s = "";
            if (isReserve) //--------------------------убрать, добавить резерв в осн. форме
            {
        ...
        private void button_Click(object sender, EventArgs e)//главный клик!
        {
            ...
            { MessageBox.Show("Сумма превышает баланс или равна нулю!"); return; }//----------------убрать, добавить массив с полями и условиями
        ...
        private void tegAddButton_Click(object sender, EventArgs e)//добавить тег в базу
        {
            ...
            catch { MessageBox.Show("Такой тег уже существует!"); }           
        }
    ...
    public enum CheckSum { Balance, Reserve, None}// -----------------удалить
}
